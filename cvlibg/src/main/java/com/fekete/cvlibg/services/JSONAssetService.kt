 ...
 *
 * Declaration in class that subclassed [com.fekete.cvlibg.ui.BaseApplication]:
 * ```
 ...
 * [com.fekete.cvlibg.ui.BaseApplication] and was added to `AndroidManifest.xml`, for more
 * detail see [com.fekete.cvlibg.ui.BaseApplication]):
 * ```
